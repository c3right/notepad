...
这是 `notepad` 的人工可读目录。规范见 [AGENTS.md](./AGENTS.md)。
...
- **2026-09-14 — [历史人生模拟案例库：Decision Atom 软评分量表 v1](./notes/2026/2026-09-14-history-decision-atom-scoring-v1.md)**  
  为M01—M10建立0/3/5评分锚点、H/M/L置信度、Scoring Context、可靠性底线与案例画像，用于通过Hard Gates后的候选排序和建设优先级判断。  
  `history` `decision-making` `case-method` `scoring` `reading-path`
